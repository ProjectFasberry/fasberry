import { ShopNickname } from "./store-wallets"
import { Typography } from "@repo/ui/typography"
import { reatomComponent } from "@reatom/npm-react"
import { Skeleton } from "@repo/ui/skeleton"
import { Donates, itemsResource, storeItem } from "../models/store.model"
import { ItemFooter, ItemsNotFound } from "./store-childs"
...
export const SelectedDonate = reatomComponent(({ ctx }) => {
  ...
  const selectedDonate = currentDonates
    ? currentDonates.find(cw => cw.origin === shopItemState.value) : null;
      ...
      <>
        ...
        <div className="flex flex-col w-full gap-4 items-center overflow-auto max-h-[260px] justify-start border-2 border-neutral-600/40 rounded-xl p-4">
          <div className="flex flex-col w-full">
            ...
            <div className="flex flex-col w-full">
              {selectedDonate.commands?.map((feature, idx) => (
