...
import { createPaymentAction, storeItem, storeTargetNickname } from './store.model';
...
export const SubscriptionItemForm = reatomComponent(({ ctx }) => {
  ...
  const isValid = shopItemState
    ? nickname && shopItemState.currency && shopItemState.paymentValue && shopItemState.paymentType && privacy
    : false;
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row items-center gap-2 w-full">
        ...
        <button
          ...
          disabled={!isValid}
          onClick={() => onSubmit()}
          className="btn py-2 w-full lg:w-2/3 rounded-lg hover:bg-[#05b458] bg-[#088d47] duration-300 backdrop-blur-lg"
        >
